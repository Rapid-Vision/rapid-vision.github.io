...
class BasicScene(rv.Scene):
    def generate(self):
        ...
        self.get_camera().set_location((7, 7, 3)).point_at(empty)`;
...
const CTAButtons = () => (
  <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
    ...
    <Link
      href="https://github.com/Rapid-Vision/rv"
      target="_blank"
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <section className="relative pt-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <CommandBlock
            className="mb-12"
            code="go install github.com/Rapid-Vision/rv@latest"
          />
        </div>
        <CTAButtons />
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap gap-8 items-center justify-center">
            <Link href="https://fasie.ru">
              <div className="bg-white p-8 rounded-lg border-slate-200 flex items-center justify-center">
                <img
                  className="max-w-64"
                  src="/fasie.png"
